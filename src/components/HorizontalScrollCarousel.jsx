...
const HorizontalScrollCarousel = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", (e) => {
      ...
      const start = document.getElementById("work-section").getBoundingClientRect().top;
  ...
  return (
    <>
      ...
      <div id="work-section" className="sticky top-[144px] h-full">
        <div id="scroller" className="overflow-x-scroll scrollbar-hide">
