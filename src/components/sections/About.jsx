    ...
    <div className="aboutw-full overflow-hidden ">
      ...
      <Container className="py-12">
        <div class="grid grid-cols-2 gap-3 font-calsans sm:gap-4 md:grid-cols-8">
          <div class="col-span-2 flex  items-center justify-center rounded-lg bg-[#18181A] px-8 py-12 sm:col-span-2 sm:row-span-2 sm:p-16 md:col-span-6">
            <div className="  ">
          ...
          <div class="rounded-lg bg-[#18181A] px-6 py-8 sm:col-span-1 sm:px-8 md:col-span-2">
            <div>
          ...
          <div class="col-span-2 rounded-lg bg-[#EE1153] p-8 md:col-span-4">
